...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__31628_SHARP_){
return ((p1__31628_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__31628_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__31630,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__31630;
}
});
...
var len__25865__auto___31633 = arguments.length;
var i__25866__auto___31634 = (0);
while(true){
if((i__25866__auto___31634 < len__25865__auto___31633)){
args__25872__auto__.push((arguments[i__25866__auto___31634]));

var G__31635 = (i__25866__auto___31634 + (1));
i__25866__auto___31634 = G__31635;
continue;
} else {
}
break;
...
var G__31632 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__31632,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__31632;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq31631){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31631));
});
...
var vec__31641 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__31641,(0),null);
var names = cljs.core.nth.call(null,vec__31641,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31641,tag_name,names){
return (function (p1__31636_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__31636_SHARP_));
});})(matches,vec__31641,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31641,tag_name,names){
return (function (p1__31637_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__31637_SHARP_));
});})(matches,vec__31641,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__31644){
var vec__31651 = p__31644;
var seq__31652 = cljs.core.seq.call(null,vec__31651);
var first__31653 = cljs.core.first.call(null,seq__31652);
var seq__31652__$1 = cljs.core.next.call(null,seq__31652);
var tag = first__31653;
var content = seq__31652__$1;
...
var vec__31654 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__31654,(0),null);
var id = cljs.core.nth.call(null,vec__31654,(1),null);
var class$ = cljs.core.nth.call(null,vec__31654,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1476131797510