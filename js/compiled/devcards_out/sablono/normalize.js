...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__68961_SHARP_){
return ((p1__68961_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__68961_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__68963,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__68963;
}
});
...
var len__48622__auto___68966 = arguments.length;
var i__48623__auto___68967 = (0);
while(true){
if((i__48623__auto___68967 < len__48622__auto___68966)){
args__48629__auto__.push((arguments[i__48623__auto___68967]));

var G__68968 = (i__48623__auto___68967 + (1));
i__48623__auto___68967 = G__68968;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__48630__auto__);
});
...
var G__68965 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__68965,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__68965;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq68964){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq68964));
});
...
var vec__68974 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__68974,(0),null);
var names = cljs.core.nth.call(null,vec__68974,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__68974,tag_name,names){
return (function (p1__68969_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__68969_SHARP_));
});})(matches,vec__68974,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__68974,tag_name,names){
return (function (p1__68970_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__68970_SHARP_));
});})(matches,vec__68974,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__68977){
var vec__68984 = p__68977;
var seq__68985 = cljs.core.seq.call(null,vec__68984);
var first__68986 = cljs.core.first.call(null,seq__68985);
var seq__68985__$1 = cljs.core.next.call(null,seq__68985);
var tag = first__68986;
var content = seq__68985__$1;
...
var vec__68987 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__68987,(0),null);
var id = cljs.core.nth.call(null,vec__68987,(1),null);
var class$ = cljs.core.nth.call(null,vec__68987,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1476044187363