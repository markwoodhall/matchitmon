...
var len__48622__auto___76670 = arguments.length;
var i__48623__auto___76671 = (0);
while(true){
if((i__48623__auto___76671 < len__48622__auto___76670)){
args__48629__auto__.push((arguments[i__48623__auto___76671]));

var G__76672 = (i__48623__auto___76671 + (1));
i__48623__auto___76671 = G__76672;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__48630__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq76667){
var G__76668 = cljs.core.first.call(null,seq76667);
var seq76667__$1 = cljs.core.next.call(null,seq76667);
var G__76669 = cljs.core.first.call(null,seq76667__$1);
var seq76667__$2 = cljs.core.next.call(null,seq76667__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__76668,G__76669,seq76667__$2);
});
...
if(cljs.core.truth_((function (){var or__47547__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__48153__auto__,writer__48154__auto__,opt__48155__auto__){
return cljs.core._write.call(null,writer__48154__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__47535__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__47535__auto__){
var or__47547__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__76673_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__76673_SHARP_));
})))){
...
var map__76682 = opts;
var map__76682__$1 = ((((!((map__76682 == null)))?((((map__76682.cljs$lang$protocol_mask$partition0$ & (64))) || (map__76682.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76682):map__76682);
var markup_db = cljs.core.get.call(null,map__76682__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__47547__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e76686){var e__61569__auto__ = e76686;
return false;
}})();
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
...
}catch (e76688){var e__61569__auto__ = e76688;
return false;
}}
})())){
...
var _STAR_current_state_STAR_76693 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__76694 = opts;
var map__76694__$1 = ((((!((map__76694 == null)))?((((map__76694.cljs$lang$protocol_mask$partition0$ & (64))) || (map__76694.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76694):map__76694);
var markup_db = cljs.core.get.call(null,map__76694__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_76693;
}});
...
;
var temp__4655__auto___76699 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___76699)){
var managed_print_level_76700 = temp__4655__auto___76699;
var _STAR_print_level_STAR_76698_76701 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_76700;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_76698_76701,managed_print_level_76700,temp__4655__auto___76699,writer,opts,job_fn){
return (function (p1__76696_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__76696_SHARP_,null);
});})(_STAR_print_level_STAR_76698_76701,managed_print_level_76700,temp__4655__auto___76699,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_76698_76701;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1476044195664