...
var len__25865__auto___40851 = arguments.length;
var i__25866__auto___40852 = (0);
while(true){
if((i__25866__auto___40852 < len__25865__auto___40851)){
args__25872__auto__.push((arguments[i__25866__auto___40852]));

var G__40853 = (i__25866__auto___40852 + (1));
i__25866__auto___40852 = G__40853;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40848){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40849,G__40850,seq40848__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40854_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__40854_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__40863__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e40867){var e__38864__auto__ = e40867;
return false;
}})();
if(cljs.core.truth_(or__24790__auto__)){
return or__24790__auto__;
...
}catch (e40869){var e__38864__auto__ = e40869;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40874 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40875 = opts;
var map__40875__$1 = ((((!((map__40875 == null)))?((((map__40875.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40875.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40875):map__40875);
var markup_db = cljs.core.get.call(null,map__40875__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40874;
}});
...
;
var temp__4655__auto___40880 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40880)){
var managed_print_level_40881 = temp__4655__auto___40880;
var _STAR_print_level_STAR_40879_40882 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40881;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40879_40882,managed_print_level_40881,temp__4655__auto___40880,writer,opts,job_fn){
return (function (p1__40877_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40877_SHARP_,null);
});})(_STAR_print_level_STAR_40879_40882,managed_print_level_40881,temp__4655__auto___40880,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40879_40882;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1476131806497