...
var G__76629 = devtools.prefs.pref.call(null,v);
v = G__76629;
continue;
} else {
return v;
...
var and__47535__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__47535__auto__){
var and__47535__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__47547__auto__ = (function (){try{if(!((value == null))){
...
}catch (e76642){var e__61569__auto__ = e76642;
return false;
}})();
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
} else {
var or__47547__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e76646){var e__61569__auto__ = e76646;
return false;
}})();
...
}catch (e76648){var e__61569__auto__ = e76648;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__47535__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__47535__auto__)){
var and__47535__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__47535__auto____$1){
...
var and__47535__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__47535__auto__)){
...
var or__47547__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
} else {
...
var and__47535__auto__ = (function (){var or__47547__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
} else {
...
var vec__76653 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__76653,(0),null);
var name = cljs.core.nth.call(null,vec__76653,(1),null);
...
var and__47535__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__47535__auto__)){
...
var or__47547__auto__ = typeof value === 'string';
if(or__47547__auto__){
return or__47547__auto__;
} else {
var or__47547__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__76656_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__76656_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476044195551