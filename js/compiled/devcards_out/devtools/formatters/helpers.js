...
var G__40810 = devtools.prefs.pref.call(null,v);
v = G__40810;
continue;
} else {
return v;
...
}catch (e40823){var e__38864__auto__ = e40823;
return false;
}})();
...
}catch (e40827){var e__38864__auto__ = e40827;
return false;
}})();
...
}catch (e40829){var e__38864__auto__ = e40829;
return false;
}}
}
});
...
var vec__40834 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40834,(0),null);
var name = cljs.core.nth.call(null,vec__40834,(1),null);
...
return cljs.core.some.call(null,(function (p1__40837_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40837_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476131806384