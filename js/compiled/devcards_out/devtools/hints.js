...
var reader = (function (){var or__47547__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__47547__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__47547__auto__)){
return or__47547__auto__;
} else {
return (128);
...
var map__77406 = top_item;
var map__77406__$1 = ((((!((map__77406 == null)))?((((map__77406.cljs$lang$protocol_mask$partition0$ & (64))) || (map__77406.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__77406):map__77406);
var file = cljs.core.get.call(null,map__77406__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__77406__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__77406__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e77405){var _e = e77405;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___77408 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___77408)){
var seen_errors_77409 = temp__4655__auto___77408;
if(cljs.core.truth_(seen_errors_77409.has(self))){
} else {
seen_errors_77409.add(self);

var temp__4657__auto___77410 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___77410)){
var sense_77411 = temp__4657__auto___77410;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_77411)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1476044196634